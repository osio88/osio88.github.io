...
// PWA
// -----------------------------------------------------------------------------
const cacheName = "app-" + "9e3cac28483ddf9baa26a259b6c60a651601af6e";
...
self.addEventListener("install", async (event) => {
  try {
    console.log("installing app worker 9e3cac28483ddf9baa26a259b6c60a651601af6e");
    await installWorker();
...
self.addEventListener("activate", async (event) => {
  try {
    ...
    console.log("app worker 9e3cac28483ddf9baa26a259b6c60a651601af6e is activated");
  } catch (error) {
